...
const Quiz = () => {
    ...
    function correct() {
        toast.success('Correct!', { position: toast.POSITION.TOP_RIGHT, autoClose: 2500 })
    }
    function incorrect() {
        toast.error('Incorrect! Maybe next time', { position: toast.POSITION.TOP_LEFT, autoClose: 2500 })
    }
                ...
                {show ? <div>
                    ...
                    <>
                        ...
                        <div className="quiz-choices">
                            {quizList[currQuestion].incorrect.map((wrong, index) => {
                                return <motion.div
                                    whileHover={{
                                        scale: 1.1,
                                        transition: {
